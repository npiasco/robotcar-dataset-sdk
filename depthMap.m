...
timestamps = ['../training/TrainDataset4v2/timestamps.txt'];
SaveDepthRefMaps( timestamps, [true true true true], root_dir, true);

run_number = train_3;
root_dir = ['../training/' run_number '/'];
timestamps = ['../training/TrainDataset3v2/timestamps.txt'];
SaveDepthRefMaps( timestamps, [true true true true], root_dir, true);

run_number = train_2;
root_dir = ['../training/' run_number '/'];
timestamps = ['../training/TrainDataset2v2/timestamps.txt'];
SaveDepthRefMaps( timestamps, [true true true true], root_dir, true);
